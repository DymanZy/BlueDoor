...
public class ToastUtil {
    ...
    public static void showDebugMessage(final Context context, final String text) {
        if (Global.Const.isDebug) {
            showMessage(context, text);
        }
    }


    public static void showDebugToast(Context context, String content) {
        if (Global.Const.isDebug) {
